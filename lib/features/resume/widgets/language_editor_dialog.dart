...
/// LanguageEditorDialog provides a full-featured modal dialog for
/// creating and editing resume languages with validation and duplicate detection.
...
class _LanguageEditorDialogState extends State<LanguageEditorDialog> {
  ...
  void initState() {
    ...
    final initialProf = widget.language?.proficiency;
    if (initialProf != null && kLanguageProficiencies.contains(initialProf)) {
      _selectedProficiency = initialProf;
    } else {
      _selectedProficiency = 'Fluent'; // Fallback / default
      if (!kLanguageProficiencies.contains('Fluent') && kLanguageProficiencies.isNotEmpty) {
        _selectedProficiency = 'Intermediate';
      }
    }
  }

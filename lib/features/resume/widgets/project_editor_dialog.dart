...
/// ProjectEditorDialog provides a modal dialog for adding and editing
/// resume projects with real-time URL and text field validation.
...
class _ProjectEditorDialogState extends State<ProjectEditorDialog> {
  ...
  void initState() {
    ...
    _nameCtrl = TextEditingController(text: proj?.name ?? '');
    _roleCtrl = TextEditingController(text: proj?.role ?? '');
    _technologiesCtrl = TextEditingController(text: proj?.technologies ?? '');
    _linkCtrl = TextEditingController(text: proj?.link ?? '');
    _descriptionCtrl = TextEditingController(text: proj?.description ?? '');
  }
